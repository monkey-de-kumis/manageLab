...
var VueSweetalert2 = (function () {
    ...
    VueSweetalert2.install = function (vue, options) {
        var _swal = function () {
            ...
            if (options) {
                var mixed = sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.mixin(options);
                return mixed.fire.apply(mixed, args);
            }
            return sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire.apply(sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a, args);
        };
        var _loop_1 = function (k) {
            if (sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.hasOwnProperty(k) && typeof sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a[k] === 'function') {
                _swal[k] = function () {
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        args[_i] = arguments[_i];
                    }
                    return sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a[k].apply(sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a, args);
                };
            }
        };
        for (var k in sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a) {
            _loop_1(k);
        }
        vue['swal'] = _swal;
...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  watch: {
    ...
    'chemicals.id': function chemicalsId() {
    ...
    'activity.name': function activityName() {
  ...
  mounted: function mounted() {
    ...
    $('#chemicals_id').select2({
      ...
      // save on var id
      _this.chemicals.id = $('#chemicals_id').val();
  ...
  methods: {
    getChemicals: function getChemicals() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/api/chemicals/".concat(this.chemicals.id)).then(function (response) {
        //assing data from server to var chemicals
        _this2.chemicals = response.data;
      });
    },
    addToElenmeyer: function addToElenmeyer() {
      var _this3 = this;

      this.submitCart = true;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/elenmeyer', this.elenmeyer).then(function (response) {
        setTimeout(function () {
          console.log(response.data);
          _this3.shoppingCart = response.data;
          _this3.elenmeyer.chemicals_id = '';
          _this3.elenmeyer.qty = 1;
          _this3.chemicals = {
            id: '',
            name: '',
            formula: ''
    ...
    getElenmeyer: function getElenmeyer() {
      var _this4 = this;

      //fetch data to server
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/api/elenmeyer').then(function (response) {
        //data from response save to var shoppingCart
        _this4.shoppingCart = response.data;
        console.log(_this4.shoppingCart);
      });
    },
    //search kegiatan
    searchActivity: function searchActivity() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/activity/search', {
        name: this.activity.name
      }).then(function (response) {
        if (response.data.status == 'success') {
          _this5.activity = response.data.data;
          _this5.resultStatus = true;
        }

        _this5.formActivity = true;
      })["catch"](function (error) {});
    },
    // method sendAnalysis() kita biarkan kosong terlebih dahulu, section selanjutnya akan di modifikasi
    sendAnalysis: function sendAnalysis() {
      var _this6 = this;
      ...
      if (this.activity.name != '' && this.customer.description != '') {
        ...
        this.$swal({
          ...
          if (result.value) {
            ...
            _this6.submitForm = true; //mengirimkan data dengan uri /checkout

            axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/checkout', _this6.activity).then(function (response) {
              setTimeout(function () {
                //jika responsenya berhasil, maka cart di-reload
                _this6.getElenmeyer(); //message di-set untuk ditampilkan


                _this6.message = response.data.message; //form customer dikosongkan
    ...
    //remove elenmeyer
    removeElenmeyer: function removeElenmeyer(id) {
      var _this7 = this;
      ...
      this.$swal({
        ...
        if (result.value) {
          //send data to server
          axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"]("/api/elenmeyer/".concat(id)).then(function (response) {
            //load new elenmeyer
...
module.exports = __webpack_require__(/*! /Users/monkey_de_kumis/Sites/projectLab/resources/assets/js/transaksi.js */"./resources/assets/js/transaksi.js");
